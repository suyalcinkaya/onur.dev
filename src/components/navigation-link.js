  ...
  return (
    ...
    >
      ...
      {shortcutNumber && (
        <span
          className={cn(
            'hidden h-5 w-5 place-content-center rounded-sm border border-gray-200 bg-gray-100 text-xs font-medium text-gray-500 transition-colors duration-200 group-hover:border-gray-300 lg:grid',
